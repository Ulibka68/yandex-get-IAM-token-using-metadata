...
const readStream = fs.createReadStream('./src/text.txt', { highWaterMark: 3 });
...
const writeStream1 = fs.createWriteStream('./tmp/text1.txt');
const writeStream2 = fs.createWriteStream('./tmp/text2.txt');
