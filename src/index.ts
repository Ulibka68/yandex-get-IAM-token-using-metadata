...
import { YC } from './yc';
import { getLogger, Driver, Logger, MetadataAuthService, Session } from 'ydb-sdk';
...
module.exports.handler = async function (event: YC.CloudFunctionsHttpEvent, context: YC.CloudFunctionsContext) {
